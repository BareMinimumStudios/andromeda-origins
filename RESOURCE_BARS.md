...
**Current release: v1.4.74.** The authoritative HUD mapping remains **25 styles on sheet 1 + 6 styles on sheet 2**. Champion Veilborn reuses the existing Auroral Mirage cooldown bar for its 5-second cooldown; sprite indices are unchanged.
