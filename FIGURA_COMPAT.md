...
**Current release: v1.4.72.** Figura hook IDs and the existing model contract are unchanged; Champion Veilborn's 5-second Auroral Mirage cooldown does not add or renumber Figura hooks.
