...
**Current release: v1.4.74.** Champion variants retain the normal Origin abilities and strengths while removing racial weaknesses/self-debuffs. Player-facing ability cooldowns recover at twice the standard rate while charge times, resource costs, and internal mechanical cadence remain unchanged. Champion Veilborn Auroral Mirage is a deliberate exception with a fixed 5-second cooldown.
